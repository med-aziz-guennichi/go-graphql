...
func (ec *executionContext) field_Mutation_createDog_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalONewDog2ᚖgithubᚗcomᚋmedᚑazizᚑguennichiᚋgoᚑgraphqlᚋgraphᚋmodelᚐNewDog(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createDog(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDog2ᚖgithubᚗcomᚋmedᚑazizᚑguennichiᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_dogs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Dog)
	fc.Result = res
	return ec.marshalNDog2ᚕᚖgithubᚗcomᚋmedᚑazizᚑguennichiᚋgoᚑgraphqlᚋgraphᚋmodelᚐDogᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNDog2githubᚗcomᚋmedᚑazizᚑguennichiᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v model.Dog) graphql.Marshaler {
	return ec._Dog(ctx, sel, &v)
}

func (ec *executionContext) marshalNDog2ᚕᚖgithubᚗcomᚋmedᚑazizᚑguennichiᚋgoᚑgraphqlᚋgraphᚋmodelᚐDogᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Dog) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNDog2ᚖgithubᚗcomᚋmedᚑazizᚑguennichiᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNDog2ᚖgithubᚗcomᚋmedᚑazizᚑguennichiᚋgoᚑgraphqlᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v *model.Dog) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalONewDog2ᚖgithubᚗcomᚋmedᚑazizᚑguennichiᚋgoᚑgraphqlᚋgraphᚋmodelᚐNewDog(ctx context.Context, v interface{}) (*model.NewDog, error) {
	if v == nil {
		return nil, nil
	}
